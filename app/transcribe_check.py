...
def test_transcribe_handles_dangling_segment():
    ...
    problem_episode = {
        ...
        "audio_download_url": "http://www.podtrac.com/pts/redirect.mp3/feeds.soundcloud.com/stream/1120216126-superdatascience-sds-503-deep-reinforcement-learning-for-robotics.mp3",
    }
    ...
    podcast.store_original_audio(
        url=problem_episode["audio_download_url"],
